...
/**
 * Renders a thrown disc lying flat and spinning with its flight speed. Shared across every
 * DyneTech disc so they all read as the same physical object in flight.
 */
public class SpinningDiscRenderer<T extends ThrowableItemProjectile> extends EntityRenderer<T> {

    private final ItemRenderer itemRenderer;

    public SpinningDiscRenderer(EntityRendererProvider.Context context) {
        super(context);
    ...
    public void render(T entity, float entityYaw, float partialTicks,
        ...
        // First-tick suppression: avoids the disc flashing in the thrower's face on spawn.
